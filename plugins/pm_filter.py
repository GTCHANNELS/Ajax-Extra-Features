...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 1 CHΛИИΞL 💠', url='https://t.me/GTCinematicUniverse'),
            InlineKeyboardButton('💠 2 CHΛИИΞL 💠', url='https://t.me/LatestMoviezOnNet')
            ],[      
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
            ],[
            InlineKeyboardButton('✅ SUBSCᏒIBΞ  ✅', url='https://youtube.com/channel/UCbVNTbMXxTz74iflJCxPVPg--HbYpMA')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
